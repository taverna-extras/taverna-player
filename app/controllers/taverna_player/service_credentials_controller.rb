    ...
    def create
      ...
      respond_to do |format|
        if @service_credential.save
          format.html { redirect_to @service_credential, :notice => 'Service credential was successfully created.' }
        else
    ...
    def update
      respond_to do |format|
        if @service_credential.update_attributes(params[:service_credential])
          format.html { redirect_to @service_credential, :notice => 'Service credential was successfully updated.' }
        else
